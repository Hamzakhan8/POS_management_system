                            ...
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{Str::words($item['name'],3)}} <br>Rs.
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <form action="{{ url('/transcation/clear') }}" method="POST">
                                    @csrf
                                    <button class="btn btn-info btn-sm " style="padding:1rem!important"
        ...
        <!-- Sorry campur2 bahasa indonesia sama inggris krn kebiasaan make b.inggris eh ternyata buat aplikasi buat indonesia jadi gini deh  -->
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h1 class="font-weight-bold mb-5">Rs. {{ number_format($data_total['total'],2,',','.') }}</h1>
